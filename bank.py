...
customerNames = ['nikhil bachu', 'varun sunchu', 'jhony phasha', 'vikas servi', 'vinay bakram']
customerPins = ['0001', '0002', '0003', '0004', '0005']
...
while True:
    ...
    choiceNumber = input("Select your choice number from the above menu (1-5): ")
    if choiceNumber == "1":
